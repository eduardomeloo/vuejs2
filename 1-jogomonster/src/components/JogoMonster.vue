...
export default {
    ...
    methods: {
        ...
        registerLog(text, cls) {
            this.logs.unshift({ text, cls }) //Adiciona sempre no início
        }
    },
    watch: {
        hasResult(value) {
...
.score {
    flex: 1; /* Faz com que cada item ocupe todo espaço */
    display: flex;
    flex-direction: column;
...
.life-bar .life {
    ...
    justify-content: center;
    height: 100%;
    /* width: 50%;  Esse atributo será controlado pelo vuejs */
